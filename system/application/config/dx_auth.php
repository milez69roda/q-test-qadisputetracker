...
$config['DX_captcha_font_size'] = '15'; 
...
|
*/
$config['DX_deny_uri'] = '/user/deny/';
$config['DX_login_uri'] = '/user/login/';
$config['DX_banned_uri'] = '/user/banned/';
$config['DX_activate_uri'] = '/user/activate/';
$config['DX_reset_password_uri'] = '/user/reset_password/';
/*
|--------------------------------------------------------------------------
...
$config['DX_change_password_uri'] = '/user/change_password/';
$config['DX_cancel_account_uri'] = '/user/cancel_account/';

// Forms view
$config['DX_login_view'] = 'user/login_form';
$config['DX_register_view'] = 'administrator/register_form';
$config['DX_forgot_password_view'] = 'user/forgot_password_form';
$config['DX_change_password_view'] = 'user/change_password_form';
$config['DX_cancel_account_view'] = 'user/cancel_account_form';

// Pages view
$config['DX_deny_view'] = 'user/general_message';
$config['DX_banned_view'] = 'user/general_message';
$config['DX_logged_in_view'] = 'user/general_message';
$config['DX_logout_view'] = 'user/general_message';

$config['DX_register_success_view'] = 'user/general_message';
$config['DX_activate_success_view'] = 'user/general_message';
$config['DX_forgot_password_success_view'] = 'user/general_message';
$config['DX_reset_password_success_view'] = 'user/general_message';
$config['DX_change_password_success_view'] = 'user/general_message';

$config['DX_register_disabled_view'] = 'user/general_message';
$config['DX_activate_failed_view'] = 'user/general_message';
$config['DX_reset_password_failed_view'] = 'user/general_message';
