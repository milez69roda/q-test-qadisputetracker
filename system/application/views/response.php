		...
		<div id="wrapper">
            <div id="content">
            	<!-- <h3><a href="client/disputelist/">Dispute/Re-Dispute List</a> > Corporate QAR Dispute Response </h3> --> 
            	<form id="form" action="" method="post" enctype="multipart/form-data" >
						...
						<table width="736" border="0" style="width:350px;" id="formtable" >
							<tbody>
                            	...
                            	<tr>
                            	  ...
                            	  <td><input type="text" name="todaysdate4" id="todaysdate4" value="<?=($class == 'nodisable' )?$userinfo[0]->user_qarno:$user2_no;?>" readonly="readonly" /></td>
                          	  </tr>
                            </tbody>
						</table>
						</div>
			       ...
			       <br />
			       <div class="box">
				   	   <h3><a class="head" href="#">-</a> Dispute</h3>				   	   
				   	   <div style="padding:5px">
				   	  	 <div>
				   			<span style="font-weight:bold">Dispute Comment: ( <?=$xdispute_registeredate?> )</span>
				   			<br/>
				   		 ...
				   		 <br/>
				   		 <div>
				 	  		<span style="font-weight:bold">Dispute Response: </span>
				 	  		<br/>
				 	  		<textarea rows="6" name="cqardispute_text" id="<?=$class?>" ><?=$disputeInfo[0]->cqardispute_text?></textarea>
				 	  		<br />				 	  		
                            	...
                            	<tr>
                                    ...
                                    <td width="192">
                                    	<select id="change_score" name="change_score" class="<?=$class1;?>">
                                    		<option value="0" <?=($disputeInfo[0]->cqarnew_score_changed == 0)?'selected="selected"':""?> >Change Score</option>
                                    		<option value="1" <?=($disputeInfo[0]->cqarnew_score_changed == 1)?'selected="selected"':""?> >Score Remains the same</option>
                                    	</select>
                                    </td>
                                </tr>
                            	<tr id="new_score_box" >
                            	  ...
                            	  <td>                            	  			
                            	  	 <input type="text" name="cqarnew_score" id="cqarnew_score" value="<?=$disputeInfo[0]->cqarnew_score?>"  class="<?=$class?>"/>
                            	  </td>
                          	  </tr>
                            </tbody>
						</table> 			    	
    	...
    	$("#form").submit( function(){
    		...
    		var val 	= jQuery.trim($("#cqarnew_score").val());
