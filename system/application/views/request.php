		...
		<script type="text/javascript" src="package/jquery/multiple-file-upload/documentation.js" ></script>
		<script type="text/javascript" src="package/jquery/multiple-file-upload/jquery.form.js" ></script>
		<script type="text/javascript" src="package/jquery/multiple-file-upload/jquery.MetaData.js" ></script>
		<script type="text/javascript" src="package/jquery/multiple-file-upload/jquery.MultiFile.js" ></script>
		<script type="text/javascript" src="package/jquery/multiple-file-upload/jquery.blockUI.js" ></script>			
								...
								<tr>
	                                ...
	                                <td width="211"><input type="text" name="evaldate" id="evaldate" readonly="readonly" value="<?=set_value('evaldate')?>" tabindex="1"/> 
	                                	<span id="notes">
	                                		...
	                                		<a href="javascript:void(0)" title="All centers have 2 days after an evaluation is completed in order to submit an evaluation" style="color:red"> *Note</a> 
	                                	</span>
	                                </td>
							  </tr>
								<tr>
	 			    ...
	 			    <br />
	 			  	<div class="box">
	 			  		...
	 			  		<div style="padding:5px">
		 			  		...
		 			  		<? //=form_dropdown('dp_selection', $dp_selection, set_value('dp_selection') );?>
		 			  		<br />
		 			  		<div>		 	
		 			  			<strong>Section:</strong><span style="color:red;font-weight:bold;font-size:18px;padding-left:5px">*</span>		  		
			 			  		<fieldset> 			 			  		
			 			  		<?php 
			 			  			foreach($dp_selection as $row){
			 			  				echo '<span>'.form_checkbox('dp_selection[]', $row->drpd_id, set_checkbox('dp_selection[]', $row->drpd_id)).' &nbsp;'.$row->dp_desc.'</span><br />';
			 			  			}
			 			  		?>
			 			  		</fieldset>		
		 			  		</div>  		
		 			  		<b>Form Attachment<span style="color:red;font-weight:bold;font-size:18px;padding-left:10px">*</span></b>
							<p style="margin:0; padding:0;color:red">Note: Maximum uploadable file is up to 4MB.</p>
		 			  		<div class="mUpload"> 
		 			  			<input type="file" name="fileX[]" class="multi" tabindex="8" />
		 			  		</div>	
		 			  		<br/><br/>
		...
		$(function() {
			...
			$('.multi').MultiFile({ 
				STRING: { 
					remove:'<img src="img/icons/delete.png" height="16" width="16"/>', 
		...
		function doIt(obj) {
			...
			$(obj).parent().prepend('<input type="file" class="upload" name="fileX[]" />');//.find("input").change(function() {doIt(this)});
			//$(".mUpload").prepend('<input type="file" class="upload" name="fileX[]" />');
			var v = obj.value;
			if(v != '') {
