	                            	...
	                            	<td width="96"><strong>Status</strong></td>
                              		...
                              		<td width="146">
                                    	<select name="type" id="type">
											...
											<option value="1" <?=( isset($_GET["type"]) && ( $_GET["type"] == 1) )?'selected="selected"':"";?>>Re-Dispute</option>
										</select>									
									</td>
                                  	<td width="74"><input class="button" name="alertbtn" id="alertbtn" type="button" value="Alert" style="width:80px; color:red" /></td>
                                  	<td width="78">&nbsp;</td>								
							  	</tr>
								<tr>
								  ...
								  <td><input class="button"  type="button" name="searchbtn" id="searchbtn" value="Search" style="width:80px" /></td>
								  <td>&nbsp;</td>
							    </tr>
								<tr>
								  ...
								  <td><input class="button" name="clearbtn" id="clearbtn" type="reset" value="Clear" style="width:80px" /></td>
								  <td>&nbsp;</td>
							  </tr>
								<tr>
	                	...
	                	?>	                	
	                        ...
	                        <tbody>
	                        		...
	                        		foreach( $disputeList as $row): 
	                        			...
	                        			switch( $row->dispute_type ){
	                                		case 0:
												...
												//else $page = 'response';
												$page = 'response';		
	                                			$isAlmostDue = ( ($oneday > 1) && isset($_GET["alert"]) && ($_GET["alert"] == 1) && ($row->dispute_type_status == 0) )?'almostdue':'';
	                                			break;
	                                		case 1:	                                		
	                        	...
	                        	<tr class="<?=$isAlmostDue;?>">
	                                ...
	                                <td><?php echo ($row->dispute_type_status == 0)? 'Pending':'Completed';?></td>
	                                ...
	                                <td><?
	                                	//echo ($row->dispute_type_status == 0)?$row->estimate_dute_date:'';
	                                	//echo '<span style="color:red"> +5 D</span>';
	                                	if( $row->dispute_type_status == 0 ){
											...
											//$_two = strtotime('+2 day', $row->last_update);
        ...
        <script>
        	...
        	$("#clearbtn").click( function(){
            	window.location = "<?=base_url();?>client/list2/";
        	})
