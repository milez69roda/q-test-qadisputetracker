		<?php 
			...
			if( ($disputeInfo[0]->redispute21_status == 0) && ($this->session->userdata('DX_access_id') == 3) ){
				$class = 'nodisable';

				/*if( strtotime( date('Y-m-d')) > strtotime($disputeInfo[0]->estimate_due_date_two_days ) ){
					$class = 'inputdisable';	
					$class1 = 'selectdisable';	

					$notification = '<div style="color:red;font-weight:bold;">This document is already been Overdue!</div><br/>';
					
            	}*/				
				
			}elseif( $disputeInfo[0]->redispute21_status == 1 ){
							...
							<table width="736" border="0" style="width:350px;" id="formtable" >
								<tbody>
	                            	<tr>
	                                    ...
	                                    <td width="192"><input type="text" name="todaysdate2" id="todaysdate2" value="<?=($class == 'nodisable' )?date('m/d/Y'):$user3_datesubmitted;?>" readonly="readonly" /></td>
	                                </tr>
	                            	<tr>
	                            	  <td><strong>Name:</strong></td>
	                            	  <td><input type="text" name="todaysdate3" id="todaysdate3" value="<?=($class == 'nodisable' )?$userinfo[0]->user_firstname.' '.$userinfo[0]->user_lastname:$user3_name;?>" readonly="readonly" /></td>
	                          	  </tr>
	                            	<tr>
	                            	  <td><strong>Contact Ext. #:</strong></td>
	                            	  <td><input type="text" name="todaysdate4" id="todaysdate4" value="<?=($class == 'nodisable' )?$userinfo[0]->user_qarno:$user3_no;?>" readonly="readonly" /></td>
	                          	  </tr>
	                            </tbody>
							</table>
						</div>
						   		...
						   		<tbody>
	                            	<tr>
	                                	<td width="475" style="border: 1px solid #fff">
											...
											<textarea rows="6" name="dispute_comment" id="textarea3" ><?=$disputeInfo[0]->redispute1_text?></textarea>										
										</td>											
	                                    <td width="495" style="border: 1px solid #fff">&nbsp;</td>
	              					</tr>
	                            	<tr>
	 			  ...
	 			  <div class="box">
 			      	...
 			      	<div>
					    ...
					    <tbody>
	                        ...
	                        <tr>
	                            <td width="316" style="border: 1px solid #fff">
					 	  			    <span style="font-weight:bold">CCCM Re-dispute #2 Response/Comment:</span> <br />
			 	  					    <textarea rows="6" name="redispute21_text" id="<?=$class?>"><?=$disputeInfo[0]->redispute21_text?></textarea>                                      
	                             </td>
	                             <td width="662" style="border: 1px solid #fff">&nbsp;</td>
	                        </tr>                        
	                        </tbody>
