		<?php 
			...
			if( ($disputeInfo[0]->cqarredispute1_status == 0) && ($this->session->userdata('DX_access_id') == 2) ){
				...
				$user2_datesubmitted = $disputeInfo[0]->xcqarredispute1_date;	
			}else{
				...
				$xevaldate =  @date('m/d/Y', strtotime($disputeInfo[0]->evaldate) );			
				...
				$user2_name= $iuser2[0]->user_firstname.' '.$iuser2[0]->user_lastname;
				$user2_no  = $iuser2[0]->user_ext;
				$user2_datesubmitted = date('m/d/Y', $disputeInfo[0]->cqarredispute1_date);			
		?>
						   		...
						   		<tbody>
	                            	...
	                            	<tr>
	                            	    <td style="border: 1px solid #fff"> 
						 	  			    <span style="font-weight:bold">Dispute Response( <?php echo $xcqardispute_date; ?> ): </span> <br />
				 	  					    <textarea rows="6" name="cqardispute_text" id="textarea2" readonly="readonly" ><?=$disputeInfo[0]->cqardispute_text?> </textarea>                         </td>
					   ...
					   <div>
						   <table width="980" border="0" >
						   		<tbody>
	                            	<tr>
	                                	<td width="475" style="border: 1px solid #fff">
	                                		<span style="font-weight:bold">Re-dispute #1 Request Comment( <?php echo $xredispute1_date; ?> ): </span> <br />
	                            	...
	                            	<tr>
	                            	    <td style="border: 1px solid #fff">
						 	  			    <span style="font-weight:bold">Re-dispute #1 Response( <?php echo $xcqarredispute1_date; ?> ): </span> <br />
					    ...
					    <tbody>
	                        <tr>
	                            <td width="316" style="border: 1px solid #fff">
					 	  			    <span style="font-weight:bold">Re-dispute #2 Request Comment:</span> <br />
			 	  					    <textarea rows="6" name="redispute2_text" id="nodisable" ></textarea>                                      
	                            </td>
